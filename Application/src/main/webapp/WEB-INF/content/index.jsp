...
<body>
	  <div class="row">
	    	<div class="col-xs-4"><img height='400px' width='660px' src="${pageContext.request.contextPath}/images/logo.png" class="img-responsive center-block"></div>
	  		<div class="col-xs-4">
	  		</div>
	    ...
	    <div class="row">
	  		<div class="col-xs-12 text-center main-part">
	  			<p class="introduction">Welcome to Mongolian National University of Medical Sciences</p>
